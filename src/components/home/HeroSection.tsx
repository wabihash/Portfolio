      ...
      <div className="mx-auto w-full max-w-6xl px-4 pb-4 pt-0 sm:pb-7 sm:pt-6 md:px-8 md:pb-10 md:pt-14 lg:pt-18">
        ...
        >
          <div className="max-w-2xl rounded-2xl p-3 sm:p-4 md:p-6">
            ...
            {/* Headline */}
            <h1
              className={"mt-2 max-w-xl text-[1.55rem] font-bold leading-[1.15] [text-shadow:0_6px_28px_rgba(0,0,0,0.98)] dark:[text-shadow:0_6px_28px_rgba(2,8,20,0.92)] sm:text-3xl md:text-5xl " + styles['hero-headline-stroke']}
              style={{ color: 'var(--hero-headline-color)' }}
            >
